...
public enum CommandInfo {
    ...
    PROJECT_DATE_START_SORT_COMMAND("project-datestartsort", "Отсортировать проекты по дате создания"),
    ...
    TASK_DATE_START_SORT_COMMAND("task-datestartsort", "Отсортировать задачи по дате создания"),
